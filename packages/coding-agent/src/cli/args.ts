...
${chalk.bold("Commands:")}
  ...
  ${APP_NAME} tool-effects <action>     Inspect or explicitly resolve an interrupted tool effect
  ${APP_NAME} <command> --help          Show help for install/remove/uninstall/update/list/config/tool-effects

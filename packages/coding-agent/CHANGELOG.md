...
- Removed the speculative pi-server provider-execution guard that rejected established custom provider registrations and active provider hooks before remote execution.

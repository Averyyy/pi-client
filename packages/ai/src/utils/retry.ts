 ...
 * - A non-retryable error (per {@link isRetryableAssistantError}, including usage,
 *   quota, or balance exhaustion) is returned immediately so deterministic errors fail fast.
 ...
 * restarted. Errors mentioning usage, quota, or balance are treated as
 * deterministic account limits; all other error text is retryable by default.
 *
